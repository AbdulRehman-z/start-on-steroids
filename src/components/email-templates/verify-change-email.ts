...
export const verifyChangeEmailTemplate = ({ user, newEmail, url }: Input) => {
	return `
																		...
																		<tr>
																				<td>
																						...
																						<p
																								...
																								We need to verify your new email address to complete the
																								update
																						</p>
																				</td>
																		</tr>
																...
																<tbody>
																		<tr>
																				<td>
																						...
																						<p
																								style="font-size:16px;color:rgb(31,41,55);line-height:24px;margin:0px;margin-bottom:16px;margin-top:0px;margin-left:0px;margin-right:0px">
																								You recently requested to change your email address. To finalize the change, please verify
																		...
																		<tr>
																				<td>
																						...
																						<p
																								...
																								didn&#x27;t request an email change, you can safely ignore this
																								email.
																						</p>
																				</td>
																		</tr>
